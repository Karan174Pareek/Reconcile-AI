...
const ENGINE_LEVELS = [
  ...
  },
  {
    ...
    processing: 'Cryptographic balance formula: Gross Order Sum - 2% MDR Fee - 18% GST on MDR === Net Bank Deposit.',
  ...
  },
  {
    ...
    processing: 'Exact & fuzzy order matching, separates claimable 18% GST Input Tax Credit (ITC) from 2% MDR fee.',
