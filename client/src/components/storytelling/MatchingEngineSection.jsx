...
const ENGINE_LEVELS = [
  {
    ...
    processing: 'Deterministic hash lookup on UTR and net amount against Razorpay settlement batch headers.',
  ...
  },
  {
    ...
    processing: 'Deterministic balance formula: Gross Order Sum - 2% MDR Fee - 18% GST on MDR === Net Bank Deposit.',
  ...
  },
  {
    ...
    badge: 'Tax Component Isolation',
    purpose: 'Matches individual order items against internal sales journals, isolating 18% GST on MDR fees.',
    input: 'Individual Order Line Items ⇄ Internal ERP Sales Invoices',
    processing: 'Exact & fuzzy order matching, separates 18% GST on MDR fee from 2% MDR fee (claimability subject to merchant tax position).',
    output: 'Reconciled Sales Invoice + Gateway Fee & Tax Entry',
