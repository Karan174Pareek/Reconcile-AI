...
const PASSES = [
  ...
  },
  {
    ...
    strategy: 'SHA-256 Ledger & Auditor Approval Gate',
    icon: ShieldCheck,
    color: 'purple',
    desc: 'Reconciled matches are sealed with SHA-256 hash chains; unresolved items await human auditor approval.',
