...
const PASSES = [
  ...
  },
  {
    ...
    criteria: 'Unmatched Candidate Context (±15% amount, ±14 days window)',
  },
  {
    id: 'final',
    num: 'FINAL',
    ...
    icon: ShieldCheck,
    color: 'purple',
    desc: 'Reconciled matches are recorded in the append-only audit trail; unresolved items await human auditor approval.',
    guarantee: 'Auditor defense & tamper-evident record keeping.',
