...
const ARCHITECTURE_NODES = [
  ...
  },
  {
    ...
    subtitle: 'Mongoose ODM • Append-Only Ledger',
    icon: Database,
    color: 'purple',
    tags: ['Immutable Log', 'Append-Only', 'Pre-Hooks'],
    details: 'Houses runs, batches, line items, matches, and exceptions with an immutable append-only event log.',
    telemetry: 'Security: Tamper-resistant ledger',
  },
];
